...
const UploadDocumentModal: React.FC<UploadDocumentModalProps> = ({ uploadDocumentModal, setUploadDocumentModal }) => {
  return (
                ...
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white pt-5 text-left shadow-xl transition-all sm:w-full sm:max-w-sm">
                  <div>
                    <div className='flex justify-end px-2'>
                      <button onClick={() => setUploadDocumentModal(false)} className="inline-flex flex-shrink-0 space-x-1 items-center rounded-full bg-gray-100 px-2 py-1 text-xs font-medium text-secondaryGray">
                        <span>Close</span>
                    ...
                    <div className="mt-3 px-6 space-y-4 text-center sm:mt-5">
                      <div className='flex items-center justify-center space-x-2'>
                        <div className="flex-shrink-0 bg-white border p-2 rounded-full">
                          <img src="/images/pdf.png" className="h-6 w-6 text-gray-400" alt="" />
                        </div>
                        <div className="flex-shrink-0 bg-white border p-2 rounded-full">
                          <img src="/images/power-point.png" className="h-6 w-6 text-gray-400" alt="" />
                        </div>
                        <div className="flex-shrink-0 bg-white border p-2 rounded-full">
                          <img src="/images/image.png" className="h-6 w-6 text-gray-400" alt="" />
                        </div>
                        <div className="flex-shrink-0 bg-white border p-2 rounded-full">
                          <img src="/images/document.png" className="h-6 w-6 text-gray-400" alt="" />
                        </div>
                      </div>
                      <div className="text-center">
                        <p className="text-sm leading-5 text-gray-600">
                          Shepherd supports <span className='text-secondaryGray font-semibold'>.pdf, .ppt, .jpg & .txt</span> document formats
                        </p>
                      </div>
                      <div className="flex w-full justify-between rounded-md bg-white ring-1 ring-primaryBlue px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-50 cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">
                        <span className="flex items-center space-x-2">
                          <UploadIcon className="text-primaryGray w-5 h-5" onClick={undefined} />
