...
const DeleteAllNotesModal: React.FC<DeleteAllNotesModalProps> = ({ deleteAllNotesModal, setDeleteAllNotesModal }) => {
  return (
                ...
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white pt-5 text-left shadow-xl transition-all sm:w-full sm:max-w-sm">
                  <div>
                    <div className='flex justify-end px-2'>
                      <button onClick={() => setDeleteAllNotesModal(false)} className="inline-flex flex-shrink-0 space-x-1 items-center rounded-full bg-gray-100 px-2 py-1 text-xs font-medium text-secondaryGray">
                        <span>Close</span>
                    ...
                    <div className="mt-3 px-6 text-center sm:mt-5">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          This will delete the selected items and all learing materials associated with these
                        </p>
                      </div>
                    </div>
                  </div>
