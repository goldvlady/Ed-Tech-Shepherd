          ...
          <ModalBody>
            <Box>
                  ...
                  <Box mb={2}>
                    ...
                    <Box>
                      <Text variant={'muted'} mb={0}>
                        Select multiple days of the week to repeat availability across them
                      </Text>
                    </Box>
                  </Box>
                  <Select
                ...
                <FormControl>
                  ...
                  <Box display={'flex'} alignItems="center" gap={'7px'}>
                    <TimePicker
                      ...
                      inputProps={{ size: 'lg', placeholder: '01:00 PM' }}
                      value={fromTime}
                      onChange={(v: string) => {
                        setFromTime(v);
                      }}
              ...
              {hoursDiff < 0 && !!fromTime && !!toTime && (
                <Alert alignItems={'center'} gap={'5px'} status="error" mt={3}>
                  <AlertIcon />
