...
import { Box, Text, HStack, VStack, IconButton, Spinner } from '@chakra-ui/react';
...
const FileDisplay: React.FC<Props> = ({ file, onDeleteClicked = null, uploading = false, prefix = null, ...rest }) => {
    ...
    return (
        <Root {...rest}>
            <HStack>
                ...
                {onDeleteClicked !== null && <IconButton
                    variant='ghost'
