...
import { PencilIcon, SparklesIcon, ArrowRightIcon, EllipsistIcon } from './icons';
import { useNavigate } from "react-router-dom";
import { Box, Text, Flex, Image, SimpleGrid, Grid, GridItem, Divider, VStack } from '@chakra-ui/react';
    ...
    <GridItem 
      ...
      <VStack spacing={3}>
        ...
        <Flex w="full" alignItems="center" justifyContent="space-between">
          <Box>
            <Text mr="1" as="span">{subject}</Text>
            <Text 
              as="p" 
              display="inline-flex" 
              align="center" 
              ...
              px={1.5} 
              py={1} 
              fontSize="xs" fontWeight="medium" color="orange.400">
      ...
      <Flex 
        ...
        >
          <Image 
            ...
            bg="gray.300" 
            src={imageURL} alt="" />
          <Text as="span" color="gray.600">{name}</Text>
        </Flex>
        <Text 
          as="p"
          fontSize="sm"
