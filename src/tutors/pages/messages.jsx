              ...
              <Tab.Group as="div" className="py-2 lg:col-span-4">
                <nav className="space-y-1">
                  <div className="top px-2">
                    ...
                    <div>
                      <div className="block">
                        <Tab.List className="flex bg-gray-100 p-1 rounded-md w-full space-x-4" aria-label="Tabs">
                          <Tab as={Fragment}>
                            {({selected}) => (
                              <span
                                className={classNames(
                                selected ? 'bg-white text-secondaryGray' : 'text-gray-500 hover:text-gray-700',
                  ...
                  <Tab.Panels>
                    <Tab.Panel as="ul" className="divide-y overflow-auto h-screen divide-gray-200">
                      <AllMessagesTab />
                      <AllMessagesTab />
                      <AllMessagesTab />
                      <AllMessagesTab />
                      ...
                      <article className=" px-2 cursor-pointer border-top">
                        <div className="flex space-x-3">
                          <span className="inline-block h-fit relative">
                            <div
                              className="h-10 w-10 bg-success text-white flex justify-center items-center rounded-full"
                            >L</div>
                          </span>
                          <div className="flex-1 space-y-1">
                            <div className="flex space-x-2">
                              <h3 className="text-sm font-medium">
                                ...
                                <span className="block text-gray-500">lesliepeters214@gmail.com</span>
                              </h3>
                            </div>
                          </div>
                        </div>
                          ...
                          >
                            <Menu.Items className="absolute space-y-3 p-2 right-0 z-50 mt-2.5 w-[14rem] origin-top-right rounded-lg bg-white py-2 shadow-xl ring-1 ring-gray-900/5 focus:outline-none">
                              <Popover className='space-y-2 border-b pb-2'>
                                <Popover.Button type="button" className='w-full bg-gray-100 rounded-md flex items-center justify-between p-2'>
                                  <div className=' flex items-center space-x-1'>
                                    ...
                                    <h4 className='text-sm text-secondaryGray font-medium'>Files</h4>
                                  </div>
                                ...
                                >
                                  <Popover.Panel className="absolute -left-[8.5rem] -top-2 z-10 mt-5 flex w-screen max-w-min -translate-x-1/2 px-4">
                                    <div className="w-64 shrink rounded-lg bg-white text-sm font-semibold leading-6 text-gray-900 shadow-lg ring-1 ring-gray-900/5">
                                      <button type="button" className='w-full hover:bg-gray-100 flex items-center justify-between p-2'>
                                        <div className='flex items-center space-x-1'>
                                          <div className='bg-white border flex justify-center items-center w-7 h-7 rounded-full'>
                                            <img src="/svgs/pdf.svg" alt='Delete Clients' className="w-4 h-4"/>
                                          </div>
                                          <h4 className='text-sm text-dark font-medium'>Meetingdoc</h4>
                                        </div>
                                      </button>
                                      <button type="button" className='w-full hover:bg-gray-100 flex items-center justify-between p-2'>
                                        <div className='flex items-center space-x-1'>
                              ...
                              <button type="button" onClick={() => setOfferModalState(true)} className='w-full hover:bg-gray-100 rounded-md flex items-center justify-between p-2'>
                                <div className='flex items-center space-x-1'>
                                  <div className='bg-white border flex justify-center items-center w-7 h-7 rounded-full'>
                                    <img src="/svgs/trash.svg" alt='Delete Clients' className="w-4 h-4"/>
                                  </div>
                                  <h4 className='text-sm text-error font-medium'>Delete Chat</h4>
                                </div>
                              </button>
                            </Menu.Items>
                          </Transition>
                            ...
                            <div class="flex items-start justify-start flex-row-reverse">
                              ...
                              >
                                ...
                                <button className='w-full bg-white mt-1 rounded-md flex items-center justify-between px-2 py-1'>
                                  <div className=' flex items-center space-x-1'>
                                    <div className='bg-white flex justify-center items-center w-8 h-8 border rounded-full'>
                                      <img src="/svgs/pdf.svg" alt="Download the document sent to you" className="w-4 h-4 text-secondaryGray"/>
                                    </div>
                                    <h4 className='text-sm text-secondaryGray font-medium'>Document title.pdf</h4>
                                  </div>
                ...
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white pt-5 text-left shadow-xl transition-all sm:w-full sm:max-w-sm">
                  <div>
                    <div className='flex justify-end px-2'>
                      <button onClick={() => setOfferModalState(false)} className="inline-flex flex-shrink-0 space-x-1 items-center rounded-md bg-gray-100 px-1.5 py-1 text-xs font-medium text-secondaryGray">
                        <span>Close</span>
                        <XMarkIcon className='w-4 h-4'/>
                      </button>
                    </div>
                    <div className="h-12 w-12 mt-4 mx-auto flex items-center justify-center bg-white border shadow-sm p-2 rounded-full">
                      <img src="/svgs/exclamation.svg" className="h-6 w-6" alt="" />
                    </div>
                    <div className="mt-3 text-center sm:mt-5">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          This will clear all conversations and remove Leslie from your message list
                        </p>
                      </div>
                    </div>
                  </div>
