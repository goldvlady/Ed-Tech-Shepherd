...
const OfferDetails = ({ name, avatarSrc, paymentAwareness, offerExpires, subjectLevel, availability, note, hourlyRate, serviceFee, finalRate, totalAmount, paymentNote }) => {
  return (
