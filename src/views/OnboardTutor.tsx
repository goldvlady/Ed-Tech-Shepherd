...
const OnboardTutor = () => {
  ...
  const validateMoreInformationStep =
    !!occupation && !!highestLevelOfEducation && !!cv && !isEmpty(teachLevel);
  ...
  const confirmations = [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          value: (
            <Text marginBottom={0}>
              {educationLevelOptions.find((el) => el.value === highestLevelOfEducation)?.label}
            </Text>
          ),
          step: 'more-info',
        },
            ...
            <VStack align="stretch" spacing={3}>
              ...
              <FormControl>
                <FormLabel>
                  ...
                  <Text variant={'muted'} marginBottom={'4px'}>
                    Please upload a PDF, JPG, or PNG file under 2MB
                  </Text>
                </FormLabel>
                {!!!selectedCV && (
                  <InputGroup>
                ...
                {!!selectedCV && (
                  <FileDisplay
                    uploading={cvUploadPercent > 0 && cvUploadPercent < 100}
                    file={selectedCV}
                    onDeleteClicked={(e) => {
                      e.preventDefault();
                      setSelectedCV(null);
            ...
            <VStack align="stretch" spacing={3}>
              <FormControl>
                ...
                {!!selectedAvatar && (
                  <FileDisplay
                    prefix={avatar ? <Avatar src={avatar} /> : null}
                    uploading={avatarUploadPercent > 0 && avatarUploadPercent < 100}
                    file={selectedAvatar}
                    onDeleteClicked={(e) => {
                      e.preventDefault();
              ...
              <FormControl>
                ...
                <Textarea
                  ...
                  value={description}
                  onChange={(e) => onboardTutorStore.set.description?.(e.target.value)}
                />
              </FormControl>
            </VStack>
          </Box>
            ...
            <FormControl>
              ...
              <InputGroup size={'lg'}>
                ...
                <Input
                  ...
                  inputMode="numeric"
                  value={rate}
                  onChange={(e) => onboardTutorStore.set.rate(parseInt(e.target.value))}
                  type="number"
