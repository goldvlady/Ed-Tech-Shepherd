    ...
    <div className="landing-wrapper">
      <div className="landing-gradient">
        ...
        <div className="landing-title-wrapper">
          <Text className="landing-title-sub">LEARN BETTER</Text>
      ...
      <div className="post-gradient">
        ...
        <div className="landing-section-info">
            ...
            <Text className="landing-title-sub">PERSONAL AI ASSISTANT</Text>
            <Text className="landing-info">
                Unlock a vast array of AI-enabled learning tools and resources with Shepherd
            </Text>
            <Text className="landing-desc">
                Shepherd is optimized for learning. It is trained on some of the most up-to-date 
                subject texts to minimize errors.
            </Text>
        </div>
        ...
        <div className="landing-section-info">
            ...
            <Text className="landing-title-sub" style={{color:'#BB38FA'}}>A MODERN TUTOR MARKET PLACE</Text>
            <Text className="landing-info">
                Still Stuck? Don't worry!
            </Text>
            <Text className="landing-desc" style={{width:'714px'}}>
                Shepherd understands one on one tutors are the biggest drivers for improving learning outcomes. 
                Shepherd connects you with the right affordable tutor for you!
            </Text>
        </div>
        <div className="landing-section-desc">
            <div className="landing-desc-info">
                ...
                <Text className="landing-desc-mini">
                    Shepherd observes your learning journey and identifies the areas where you need help the most.
                </Text>
        ...
        <div className="landing-section-desc">
            <div>
                ...
                <Text className="landing-desc-mini">
                    With Shepherd, no one is left out, by leveraging our array of AI-powered tools everyone can tap into the transformative power of technology, unlocking their full potential.
                </Text>
            </div>
            <div>
