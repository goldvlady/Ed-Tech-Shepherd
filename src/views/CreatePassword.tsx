import { Box, Button, FormControl, FormErrorMessage, FormLabel, Heading, Link, Text, useToast } from '@chakra-ui/react';
...
const CreatePassword: React.FC = () => {
    ...
    return <Root>
        <Box mb={'20px'}>
            <Heading mb={'12px'} as={'h3'} textAlign={"center"}>Create New Password</Heading>
            <Text m={0} className='body2' textAlign={"center"}>Create a strong and secure password for signing in to your account</Text>
        </Box>
        <Box>
            <Formik
                    ...
                    try {
                        ...
                        switch (e.code) {
                            case 'auth/invalid-action-code':
                                errorMessage = "Your password reset link is invalid or expired";
                                break;
                            default:
                ...
                {({
                    ...
                    <Form>
                        ...
                        <Box marginTop={'36px'} display={"flex"} flexDirection="column" gap={4} justifyContent="flex-end">
                            ...
                            <Link color='primary.400' className='body2 text-center' as={RouterLink} to='/login'><span className='body2'>Remember your old password?</span> Sign in now</Link>
                        </Box>
                    </Form>
                )}
            </Formik>
