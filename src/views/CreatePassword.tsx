...
const ForgotPasswordSchema = Yup.object().shape({
  password: Yup.string()
    ...
    .min(MinPasswordLength, `Your password must be a minimum of ${MinPasswordLength} characters`),
          ...
          {({ errors, isSubmitting, values }) => (
            <Form>
              ...
              <Box
                ...
                <Link color="primary.400" className="body2 text-center" as={RouterLink} to="/login">
                  <span className="body2">Remember your old password?</span> Sign in now
                </Link>
              </Box>
            </Form>
          )}
