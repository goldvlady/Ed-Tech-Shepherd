    ...
    <>
      <Layout className="px-4">
        ...
        <div className="mx-auto max-w-7xl px-4 py-10 sm:px-2">
          <div className="mx-auto grid max-w-2xl grid-cols-1 grid-rows-1 items-start gap-x-8 gap-y-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            {/* Offer Summary */}
            <OfferSummary
              setDeclineOfferModalState={setDeclineOfferModalState}
              setOfferModalState={setOfferModalState}
            />
      ...
      <Transition.Root show={offerModalState} as={Fragment}>
        <Dialog as="div" className="relative z-50" onClose={setOfferModalState}>
          <AcceptOfferModal
            offerModalState={offerModalState}
            setOfferModalState={setOfferModalState}
          />
        </Dialog>
      </Transition.Root>
      ...
      <Transition.Root show={declineOffferModalState} as={Fragment}>
        ...
        >
          <DeclineOfferModal
            declineOfferModalState={declineOffferModalState}
            setDeclineOfferModalState={setDeclineOfferModalState}
          />
        </Dialog>
      </Transition.Root>
