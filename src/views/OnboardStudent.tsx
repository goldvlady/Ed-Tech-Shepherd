                    ...
                    <LargeSelect value={parentOrStudent} onChange={(v) => onboardStudentStore.set.parentOrStudent(v)} options={[
                        {
                            value: "parent",
                                ...
                                },
                                {
                                    ...
                                    title: 'Student',
                                    subtitle:
                                        "Choose this if you're signing up for yourself",
                                    icon: (
                                        <svg
                                            width="16.7"
                                            height="16.7"
                    ...
                    <OnboardStep canGoNext={false} hideNav={true}>
                        <Box paddingBottom={5}>
                            ...
                            <Text
                                ...
                                textAlign="center"
                            >
                                We'll match you with the best tutors around
                                &amp; we'll shoot you an email at {email} when
                                we're done!
                            </Text>
                        </Box>
                    </OnboardStep>
