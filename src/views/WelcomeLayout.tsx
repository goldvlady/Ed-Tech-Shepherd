...
const welcomeItems = [
    {
        ...
        subtitle: "Shepherd provides you with numerous engaging features to make learning fun.",
        imageSource: "/images/welcome-interactive-learning.svg",
    },
    {
        title: "Find the best tutors",
        subtitle: "Connect with top-rated tutors and get the support you need to achieve your goals.",
        imageSource: "/images/welcome-find-tutors.svg",
    },
    {
        title: "Your personal AI assistant",
        subtitle: "With your personal AI assistant, you'll have access to a wealth of learning resources.",
        imageSource: "/images/welcome-ai-assistant.svg",
    },
    {
        title: "Learning insights",
        subtitle: "Shepherd provides you with detailed analytics on your study sessions.",
    ...
    <Root className="container-fluid">
        ...
        <WelcomeColumn className="col-sm-5 p-0">
            ...
            <WelcomeItems>
                {
                    [1, 2, 3, 4].map((v) => {
                        return <MarqueeWrapper key={v}>
                            <Marquee>
                                <WelcomeItemRow>
                                    {
                                        welcomeItems.map(wi => {
                                            return <WelcomeItemWrapper key={wi.title}>
                                                <WelcomeItem {...wi} />
                                            </WelcomeItemWrapper>
                                        })
                                    }
