...
const Offer = () => {
    ...
    const setupPaymentMethod = async () => {
        ...
        try {
            const paymentIntent =
                await ApiService.createStripeSetupPaymentIntent({
                    offerId: offer?._id,
                });
                    ...
                    {!!offer && (
                        <Box>
                            ...
                            {user?.type === 'student' &&
                                offer.status === 'draft' && (
                                    <PageTitle
                                        ...
                                        mb={10}
                                        title="Offer"
                                        subtitle={`You made an offer to ${offer.tutorLead.name.first}`}
                                    />
                                )}
                            {user?.type === 'student' &&
                            ...
                            <VStack spacing="32px" alignItems={'stretch'}>
                                ...
                                {user?.type === 'student' && (
                                    <TutorCard tutor={offer.tutorLead} />
                                )}
                                <Panel>
                                ...
                                <Panel>
                                    ...
                                    <Box mt={8}>
                                        ...
                                        >
                                            ...
                                            {Object.keys(offer.schedule).map(
                                                (d) => {
                                                    const n = parseInt(d);
                                                    return (
                                                        <Box key={d}>
                                ...
                                <Panel>
                                    ...
                                    {user?.type === 'tutor' && (
                                        <Alert status="info" mt="22px">
                                            ...
                                            <AlertDescription>
                                                Initial payment will not be made
                                                until after the client reviews
                                                the offer after the first
                                                session. The client may decide
                                                to continue with you or withdraw
                                                the offer
                                            </AlertDescription>
                                        </Alert>
                                    )}
                                    {user?.type === 'student' && (
                                        <Alert status="info" mt="22px">
                                            ...
                                            <AlertDescription>
                                                Payment will not be deducted
                                                until after your first lesson,
                                                You may decide to cancel after
                                                your initial lesson.
                                            </AlertDescription>
                                        </Alert>
                                    )}
                                    ...
                                    !offer.expired && (
                                        ...
                                        >
                                            ...
                                            <Text
                                                ...
                                                className="body2"
                                            >
                                                Respond to the offer before it
                                                expires
                                            </Text>
                                ...
                                {offer?.status === 'declined' && (
                                    <Panel borderRadius={'10px'}>
                                        ...
                                        <VStack mt={8} spacing={'16px'}>
                                            <Button
                                                as="a"
                                                href={`../tutor/${offer?.tutorLead._id}/offer`}
                                                w={'100%'}
                                                variant="solid"
                                            >
                                                Update Offer
                                ...
                                {offer?.status === 'accepted' && (
                                    <Panel borderRadius={'10px'}>
                                        ...
                                        >
                                            ...
                                            has been added to your tutor list,
                                            send them a message
                                        </Text>
                                        <VStack mt={8} spacing={'16px'}>
                                            <Button
