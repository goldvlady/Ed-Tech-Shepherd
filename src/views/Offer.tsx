                    ...
                    <Box w={"100%"} mt={5} textAlign="center">
                      ...
                      <Box marginTop={0}>
                        ...
                        <div style={{ color: theme.colors.text[400] }}>
                          {offer.studentLead.name.first}{" "}
                          {offer.studentLead.name.last} has been added to your
                          message list
                        </div>
                      </Box>
                    </Box>
                      ...
                      <Box>
                        ...
                        >
                          ...
                          <Box color="primary.400" as={"span"}>
                            ...
                            {(offer.rate * ServiceFeePercentage).toFixed(2)}/hr)
                          </Box>
                        </Text>
                      </Box>
                      <Box>
                        ...
                        <OfferValueText>
                          ${offer.rate - offer.rate * ServiceFeePercentage}/hr
                        </OfferValueText>
                      </Box>
                      <Box>
                ...
                {offer?.status === "accepted" && (
                  <Panel borderRadius={"10px"}>
                    ...
                    <Text textAlign={"center"} mt={"7px"} className="body2">
                      {capitalize(offer.tutorLead.name.first)} has been added to
                      your tutor list, send them a message
                    </Text>
                    <VStack mt={8} spacing={"16px"}>
