...
export default function TutorCard(props: any) {
  const { id, name, levelOfEducation, avatar, use, rate, saved, description, rating, reviewCount } =
    props;
  return (
    <LinkBox as="article">
      <Center justifyContent="left">
        <Stack
          ...
          <Image src={saved ? Ribbon2 : Ribbon} position="absolute" top={2} right={2} width={4} />
        </Stack>
      </Center>
    </LinkBox>
  );
