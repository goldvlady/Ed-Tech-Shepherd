...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  return (
    ...
    >
      ...
      <Box ml={8}>
        <NavItem path="/my-tutors">My Tutors</NavItem>
        <NavItem path="/saved-tutors">Bookmarks</NavItem>
      </Box>
      <Divider />
      {LinkItems.map((link) => (
        <>
